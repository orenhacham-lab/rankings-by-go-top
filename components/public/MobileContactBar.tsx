...
export function MobileContactBar() {
  ...
  const t = isEn
    ...
    : {
        ...
        whatsappAria: 'פנייה אלינו בוואטסאפ',
        whatsapp: 'וואטסאפ',
    ...
    >
      <div className="flex w-full items-stretch gap-3 p-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))]">
        <a
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#25D366] py-3 text-sm font-bold text-white shadow-sm transition-colors active:scale-[0.98] hover:bg-[#20bd5a]"
        >
