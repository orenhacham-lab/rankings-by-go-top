...
const cleanDiag = (over: Partial<BriefRunDiagnostics> = {}): BriefRunDiagnostics => ({
  ...
  brief_consumption: { effectivePoolSize: 6, consumedBriefs: 6, remainingBriefs: 0, callsRemaining: 1 }, thirdRefillEligible: false, thirdRefillUsed: false, synthesisCallsMade: 0, thirdCallStrategy: 'not_used', lowYieldFallback: { eligible: false, used: false, triggerAcceptedCount: 0, coverageRejectionRatio: 0, rawSeedCount: 0, eligibleSeedCount: 0, seedsSent: 0, emitted: 0, engineAccepted: 0, finalReady: 0, callOrdinal: null, excludedBySource: { keywordResearch: 0, searchConsole: 0, tracked: 0, entity: 0, projectFocus: 0 }, excludedByReason: {}, ideaStatusBlocks: { pending: 0, approved: 0, rejected: 0, generated: 0, other: 0 } }, lowYieldFallbackBriefIds: [], lowYieldGscAcceptedBriefIds: [],
