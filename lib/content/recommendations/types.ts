...
export interface TopicSuggestion {
   ...
   *  signal). Preview-only. */
  coverageMatches?: { existingTitle: string; url: string | null; matchType: string; score: number; sharedNeed: string[]; unmatchedEntities?: string[]; basisPageType?: string | null }[]
