...
function main() {
  ...
  function staticGuards() {
    ...
    check('(K) route surfaces gscInput in diagnostics (with resolved GSC detail finalOutcomes)', /gscInput: gscInputEnriched/.test(route) && /applyFinalOutcomesToGscDetails\(briefDiagnostics\?\.gscInput/.test(route))
