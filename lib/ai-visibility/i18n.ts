...
const STRINGS = {
  ...
  geo_opp_no_data_content: { he: 'עדיין אין מספיק נתונים כדי לזהות דפוסי תוכן.', en: 'Not enough scans yet to identify content patterns.' },
  geo_opp_no_data_citations: { he: 'עדיין אין מספיק נתונים כדי לזהות דפוסי מקורות.', en: 'Not enough scans yet to identify source patterns.' },
  geo_opp_no_data_engines: { he: 'עדיין אין מספיק תוצאות מוצלחות כדי לזהות דפוסי מנוע.', en: 'Not enough successful results yet to identify engine patterns.' },
  geo_opp_no_data_missing: { he: 'עדיין אין מספיק תוצאות כושלות כדי לזהות פערים.', en: 'Not enough unsuccessful results yet to identify gaps.' },
