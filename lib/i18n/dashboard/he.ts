export const dashboardHe = {
  ...
  contentHub: {
    ...
    autoIdeas: {
      ...
      engineRejectionItem: '{n} — {reason}',
      engineNotReviewedLine: 'עוד {n} לא נבדקו: כבר היו לריצה מספיק רעיונות.',
      engineDroppedLine: '{n} לא ניתן היה לשייך חזרה למקור שלהם ואבדו בשל תקלה פנימית.',
      engineUnexplainedLine: '{n} הוסרו בלי שנרשמה סיבה — תקלה פנימית, לא שיפוט של הרעיון.',
      rejectionReasonOther: 'זה לא עבר אחת מהבדיקות שלנו',
      rejectionReasons: {
        invalid_primary_keyword: 'ביטוי החיפוש לא היה שמיש',
        intent_keyword_mismatch: 'הכותרת, ביטוי החיפוש וכוונת החיפוש לא התאימו זה לזה',
        final_keyword_lost_subject: 'ביטוי החיפוש כבר לא ציין את הנושא',
        primary_keyword_not_search_phrase: 'ביטוי החיפוש נקרא ככותרת ולא כמשהו שאנשים מחפשים',
        title_keyword_mismatch: 'הכותרת וביטוי החיפוש עסקו בדברים שונים',
        unsafe_named_entity_mutation: 'הכותרת שינתה שם לשם שאינו בשימוש באתר שלך',
        title_named_external_business: 'הכותרת ציינה עסק שאינו שלך',
        title_unknown_latin_token: 'הכותרת השתמשה במותג או בשם שאינם בשימוש באתר שלך',
        already_covered: 'האתר שלך כבר מכוון לביטוי החיפוש הזה',
        exact_existing_keyword_owner: 'עמוד קיים כבר מחזיק בביטוי החיפוש הזה',
        covered_by_existing_content: 'תוכן קיים באתר שלך כבר מכסה את זה',
        existing_content_owns_need: 'עמוד קיים כבר עונה על הצורך הזה',
        primary_keyword_exists: 'רעיון שמור כבר משתמש בביטוי החיפוש הזה',
        pending_semantic_duplicate: 'זה חזר על רעיון שכבר ממתין לאישור שלך',
        intra_run_need_duplicate: 'זה חזר על רעיון אחר מאותה ריצה',
        insufficient_independent_need: 'זה לא עמד בפני עצמו כמאמר נפרד',
        exact_keyword_equality: 'עמוד קיים מכוון בדיוק לביטוי החיפוש הזה',
        high_keyword_overlap: 'הייתה חפיפה גדולה מדי עם עמוד קיים',
        entity_plus_generic_only: 'זה רק הוסיף ניסוח כללי לעמוד שכבר יש לך',
        commercial_overlap_single_modifier: 'זה היה קרוב מדי לעמוד מסחרי קיים',
        empty_candidate: 'הרעיון הגיע ריק',
        no_matching_page: 'אין באתר שלך עמוד שיכול לתמוך בזה',
    ...
    newTopicsPlan: {
      ...
      // אינדקס האתר הוא רשות: הוא מזין הצעות לקישורים פנימיים ואינו תנאי
      // לכתיבת מאמר או להוספתו לתור. מנוסח כמידע ולא כחסימה.
      cacheMissing: 'אינדקס האתר לא נסרק, ולכן אין הצעות לקישורים פנימיים. אפשר עדיין להוסיף את הנושאים לתור.',
      queueWithoutLinks: 'הוסף לתור ללא קישורים פנימיים',
      // לנושאים כבר יש תכנון קישורים שמור ואין אינדקס אתר, ולכן אי אפשר לשמור
      // מחדש — התכנון הקיים נתבע ומאומת בשרת.
      queueWithSavedPlan: 'הוסף לתור עם הקישורים השמורים',
      savedLookupError: 'לא הצלחנו לבדוק אם לנושאים האלה כבר יש תכנון קישורים שמור.',
      savedLookupRetry: 'נסו שוב',
      mixedSavedPlans: 'לחלק מהנושאים כבר יש תכנון קישורים שמור ולחלק אין. ללא אינדקס אתר אי אפשר להוסיף אותם יחד — הסירו סימון מקבוצה אחת והוסיפו אותן בנפרד.',
    ...
    topicPlan: {
      ...
      // אינדקס האתר הוא רשות: הוא מזין הצעות לקישורים פנימיים ואינו תנאי
      // לכתיבת מאמר או להוספתו לתור. מנוסח כמידע ולא כחסימה.
      cacheMissing: 'אינדקס האתר לא נסרק, ולכן אין הצעות לקישורים פנימיים. אפשר עדיין להוסיף את הנושא לתור.',
      queueWithoutLinks: 'הוסף לתור ללא קישורים פנימיים',
    ...
    genErrors: {
      ...
      shopify_reauthorization_required: 'צריך לחבר מחדש את חנות ה-Shopify — ההרשאה שלה אינה בתוקף. התוכן שלכם נשמר.',
      shopify_app_not_configured: 'פרטי אפליקציית ה-Shopify לחנות הזו אינם מוגדרים. פנו לתמיכה.',
  ...
  billing: {
    ...
    marketPrompt: {
      title: 'באיזה מטבע תרצו לשלם?',
      description: 'לא נמצאה עבורכם העדפת מטבע קיימת. בחרו פעם אחת — הבחירה תישמר לחשבון שלכם.',
      ilsOption: '₪ שקלים (ILS)',
      usdOption: '$ דולר (USD)',
      saving: 'שומר...',
      currentMarketPrefix: 'מטבע החיוב שלך:',
      ilsLabel: '₪ שקלים (ILS)',
      usdLabel: '$ דולר (USD)',
    },
    manage: {
