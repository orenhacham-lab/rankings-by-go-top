  ...
  projectDetail: {
    ...
    contentSection: {
      ...
      gscRecommendations: {
        ...
        titles: {
          improve_ctr: (label: string | null) => `The page ${label ? `"${label}"` : 'that ranks'} gets many impressions but few clicks`,
          improve_page: (label: string | null) => `The page ${label ? `"${label}"` : 'that ranks'} ranks for a group of searches but isn't reaching its potential`,
          internal_links: (label: string | null) => `The page ${label ? `"${label}"` : 'that ranks'} could be strengthened with internal links`,
        ...
        actions: {
          improve_ctr: 'Check title & description',
          improve_page: 'Review page alignment',
          internal_links: 'Review internal links',
          page_overlap: 'Review the pages',
        },
