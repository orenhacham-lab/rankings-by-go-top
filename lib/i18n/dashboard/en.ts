  ...
  projectDetail: {
    ...
    contentSection: {
      ...
      gsc: {
        ...
        confirmRevoke: 'Disconnect the Google account?\n\n• Previously synced performance data is preserved.\n• Future syncs will stop until you reconnect.\n\nContinue?',
        ...
        errors: {
          ...
          property_url_mismatch: 'The property does not match the project domain.',
