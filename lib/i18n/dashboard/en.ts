...
export const dashboardEn = {
  ...
  contentHub: {
    ...
    autoIdeas: {
      ...
      engineNotReviewedLine: '{n} more were not reviewed: the run already had enough ideas.',
      engineDroppedLine: '{n} could not be matched back to their source and were lost to an internal problem.',
      engineUnexplainedLine: '{n} were removed with no reason recorded — an internal problem, not a judgement about the idea.',
      rejectionReasonOther: 'it did not pass one of our checks',
      rejectionReasons: {
        invalid_primary_keyword: 'the target search phrase was not usable',
        intent_keyword_mismatch: 'the title, the search phrase and the search intent did not match',
        final_keyword_lost_subject: 'the search phrase no longer named the topic',
        primary_keyword_not_search_phrase: 'the search phrase read like a headline, not like something people search',
        title_keyword_mismatch: 'the title and the search phrase were about different things',
        unsafe_named_entity_mutation: 'the title altered a name into one your site does not use',
        title_named_external_business: 'the title named a business that is not yours',
        title_unknown_latin_token: 'the title used a brand or name your site does not use',
        already_covered: 'your site already targets this search phrase',
        exact_existing_keyword_owner: 'an existing page already owns this search phrase',
        covered_by_existing_content: 'existing content on your site already covers it',
        existing_content_owns_need: 'an existing page already answers this need',
        primary_keyword_exists: 'a saved idea already uses this search phrase',
        pending_semantic_duplicate: 'it repeated an idea already waiting for your approval',
        intra_run_need_duplicate: 'it repeated another idea from this same run',
        insufficient_independent_need: 'it did not stand on its own as a separate article',
        exact_keyword_equality: 'an existing page targets exactly this search phrase',
        high_keyword_overlap: 'it overlapped too much with an existing page',
        entity_plus_generic_only: 'it only added generic wording to a page you already have',
        commercial_overlap_single_modifier: 'it was too close to an existing commercial page',
        empty_candidate: 'the idea arrived empty',
        no_matching_page: 'no page on your site could support it',
    ...
    genErrors: {
      ...
      shopify_reauthorization_required: 'Your Shopify store needs to be reconnected — its authorization is no longer valid. Your content is safe.',
      shopify_app_not_configured: 'The Shopify app credentials for this store are not configured. Please contact support.',
  ...
  projectDetail: {
    ...
    keywordsSection: {
      ...
      volumesInProgress: 'A search-volume update is already running for this project.',
    ...
    messages: {
      ...
      scanInProgress: 'A check is already running for this selection. Please wait for it to finish.',
  ...
  billing: {
    ...
    marketPrompt: {
      title: 'Which currency would you like to pay in?',
      description: 'We couldn’t find an existing currency preference for your account. Choose once — this is saved to your account.',
