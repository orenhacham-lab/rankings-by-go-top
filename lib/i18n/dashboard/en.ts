...
export const dashboardEn = {
  ...
  contentHub: {
    ...
    autoIdeas: {
      ...
      planModeLabel: 'Generation mode',
      planModeQuick: 'Quick scan — up to 10 topics',
      planModePlan: 'Content plan — up to 25 topics',
      planModeCalendar: 'Full calendar — up to 50 topics',
      planEstimate: 'Up to {count} safe distinct topics · up to {calls} AI calls · estimated max cost ${cost}. Fewer may be returned if not enough safe topics exist.',
      planTakesLonger: 'A full plan can take longer than a quick scan.',
      planResultTitle: 'Plan result',
      planResult: '{accepted} of {requested} accepted · {calls} calls · est. cost ${cost} · ${per} per accepted topic.',
      planShortfall: 'No {shortfall} additional safe distinct topics were found in the current evidence.',
