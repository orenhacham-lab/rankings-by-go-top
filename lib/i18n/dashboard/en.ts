...
export const dashboardEn = {
  ...
  contentHub: {
    ...
    brief: {
      ...
      planHint: 'Choose internal links to include in the article brief. The system weaves the anchors into the body while writing, then validates and inserts the links in the editor.',
      ...
      planAddManualTarget: 'Add internal target manually',
      planManualTargetPlaceholder: 'Paste an internal URL from the same site',
      planManualTargetInvalid: 'The URL does not belong to the project domain.',
