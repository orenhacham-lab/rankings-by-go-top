    ...
    editor: {
      ...
      linkApply: {
        ...
        reasons: {
          ...
          anchor_not_found_in_safe_prose: 'Anchor not found in body text',
          target_already_linked: 'Link already exists in the draft',
          plan_stale: 'Plan is stale',
          cache_stale: 'Link index is stale',
          cache_version_stale: 'Link index version is outdated',
          target_missing_from_cache: 'Target not found in the current index',
          target_now_ineligible: 'Target is no longer eligible',
