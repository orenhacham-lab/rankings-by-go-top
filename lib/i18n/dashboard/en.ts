...
export const dashboardEn = {
  ...
  contentHub: {
    ...
    autoSchedule: {
      ...
      runNowLabel: 'Run one manual pass',
      runNowHelper: 'For testing/admin. A run prepares the next queued article, or publishes only an article that is already due. It never bypasses topic approval or scheduling.',
