...
export const PLAN_FEATURES: Record<PlanType, string[]> = {
  ...
  regular:  ['עד 3 פרויקטים', 'עד 50 מילות מפתח לפרויקט', 'סריקה 1 בחודש'],
  advanced: ['עד 10 פרויקטים', 'עד 50 מילות מפתח לפרויקט', '2 סריקות בחודש'],
  premium:  ['עד 50 פרויקטים', 'עד 100 מילות מפתח לפרויקט', '4 סריקות בחודש'],
}
