          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                title: 'מחקר ביטויים',
                desc: 'גלו ביטויים רלוונטיים עם נתוני Google Ads. בדקו נפחי חיפוש ותחרות, והוסיפו ישירות למעקב או ליצירת שאלות AI.',
              ...
              },
              {
                ...
                desc: 'קבלו התראות על שינויים חשובים במיקומים, עקבו אחרי תנודות משמעותיות וחסכו בדיקות ידניות.',
