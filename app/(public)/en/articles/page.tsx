    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 flex flex-col">
      ...
      <div className="flex-1">
        <div className="max-w-6xl mx-auto pt-28 pb-12 px-4">
          <Breadcrumbs items={[{ label: 'Articles', href: '/en/articles' }]} />
          <div className="mb-12">
            <h1 className="text-4xl font-bold text-slate-900 mb-2">Articles</h1>
            <p className="text-slate-600">Articles and tips on SEO, digital marketing and technology</p>
          </div>
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="text-white">
                ...
                <p className="text-blue-100 text-lg mb-6 leading-relaxed">
                  Professional platform for tracking your Google organic and Google Maps rankings. Detailed reports, trend tracking and personal support in English.
                </p>
