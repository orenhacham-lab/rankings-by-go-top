        ...
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
          ...
          <div className="prose prose-sm max-w-none space-y-6 text-slate-700 leading-relaxed">
            ...
            <section>
              ...
              <p>
                המערכת פועלת במודל מנוי חודשי. התשלום מתבצע באמצעות ספק תשלומים חיצוני (PayPal). כל עוד
                המנוי פעיל, החיוב יתחדש באופן אוטומטי בכל חודש לפי התוכנית שנבחרה. המחירים, התוכניות
                והמגבלות עשויים להשתנות מעת לעת והעדכון יוצג במערכת ובמחירון.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                Perplexity ואחרים), ספקי תשלום (PayPal) וספקי תשתית ואחסון (Supabase וספקי hosting
