...
const faqs = [
  ...
  },
  {
    ...
    a: 'סריקה אחת בודקת את המיקום של כל מילות המפתח שהגדרת בפרויקט בגוגל אורגני ובגוגל מפות, ומפיקה דוח מלא עם המיקומים, המגמות והשינויים. סריקת AI בודקת נראות בתשובות של מנועי AI השונים.',
  },
  {
